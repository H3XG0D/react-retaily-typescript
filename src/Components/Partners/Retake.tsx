...
const Retake = (props: PropsType) => {
  const data = [
    ...
    {
      title:
        "Возможность показать в формате сториз акции, новинки, другую полезную информацию",
    },
  ...
  const data2 = [
    ...
    {
      title:
        "Онлайн мониторинг статуса вашей заявки (принят, отгружается и др.)",
    },
    ...
    <div className="main__retake_bg">
      <div className="wrapper">
        <div className="main__retake">
          <div className="main__retake_hide_retake">RETAILY</div>
          <div className="main__retake-content">
            ...
            <div className="main__retake-content-image">
              {props.slider ? (
                <div className="main__retake-content-image_macbook2"></div>
              ) : (
