            ...
            <div className="wrapper">
                <div className="main__supplier">
                    ...
                    <div className="main__supplier_btn_more">
                        ...
                        >
                            <p>
                                1. Заключение договора оказания информационных услуг и назначение
                                ответственного за интеграцию со стороны поставщика; На данном этапе
                                подписывается договор оказания услуг любым удобным способом (ЭДО,
                                сканом на электронную почту или на бумаге Почтой России). Далее
                                Поставщик обязан будет назначить ответственного, который будет
                                контактным лицом по всем вопросам, связанным с подключением к
                                системе.
                            </p>
                            <br/>
                            <p>
                            ...
                            <p>
                                ...
                                зависимости от пожеланий поставщика. На данном этапе прорабатываются
                                все специфические моменты, учитываются все пожелания поставщика.
                            </p>
                            <br/>
                            <p>
