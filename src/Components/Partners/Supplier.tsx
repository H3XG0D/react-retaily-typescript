    ...
    <div className="main__supplier-bg">
      <div className="wrapper">
        <div className="main__supplier">
          ...
          <div className="main__supplier-mobile">
              ...
              <div className="main__supplier-step-rightSide">
                <div className="main__supplier-step-item">
                  ...
                  <div className="main__supplier-step-item_btn1">
                    <Button
                        className="main__supplier-step-item_btn2"
                      type="primary"
                      style={{
                        fontSize: "14px",
                        height: "32px",
                ...
                <div className="main__supplier-step-item">
                  <div className="main__supplier-step-mobile">
            ...
            <div className="main__supplier-btn">
              <Button
                type="primary"
                onClick={showModal}
                className="main__supplier-step-btn"
                style={{
                  fontSize: "15px",
                  height: "35px",
                  width: "250px",
            ...
            <div className="main__supplier_btn_more">
              ...
              >
                <p>
                  ...
                  удобным способом (ЭДО, сканом на электронную почту или на
                  бумаге Почтой России). Далее Поставщик обязан будет назначить
                  ответственного, который будет контактным лицом по всем
                  вопросам, связанным с подключением к системе.
                </p>
                <br />
                <p>
                  2. Передача API и интеграция с 1C поставщика, настройка
                  Личного кабинета на Web-портале, краткое обучение общему
                  функционалу и инструментам сайта. Срок – от 7 дней, в
                  зависимости от скорости настройки со стороны поставщика услуг
                  1С.
                </p>
                <br />
                <p>
                  3. Тестирование. На фирменной торговой сети – при наличии. При
                  отсутствии – на любом выбранном Вами магазине. Срок от 7 дней
                  в зависимости от пожеланий поставщика. На данном этапе
